      ...
      <div class="card-panel grey lighten-5 z-depth-1">
         <div class="row valign-wrapper">
            ...
            <ul id='dropdown{{ $message->id }}' class='dropdown-content'>
               <li>
                  <a href="#!" class="red-text msgDel" url='{{url("admin/message/$message->id")}}'
                     msgId="{{ $message->id }}">
               ...
               <li>
                  <a href="#!" class="green-text msgEdit" url='{{url("admin/message/$message->id")}}'
                     msgId="{{ $message->id }}">
            ...
            <div class="col s12">
               <div class="row">
                  <form msgId="{{ $message->id }}" method="post" style="display: none"
                     action='{{ route("admin.msg-reply") }}' class="col s12 reply-form" enctype="multipart/form-data">
                     @csrf
            ...
            <div class="col s12 reply-range">
               ...
               <div>
                  ...
                  <ul id='reply{{ $message->id }}_{{ $reply->id }}' class='dropdown-content'>
                     <li>
                        <a href="#!" class="red-text replyDel" url='{{url("admin/reply/$reply->id")}}'
                           replyId="{{ $reply->id }}">
                           <i class="material-icons msgI">delete</i>
                           刪除
                        </a>
                     ...
                     <li>
                        <a href="#!" class="green-text replyEdit" url='{{url("admin/reply/$reply->id")}}'
                           replyId="{{ $reply->id }}">
                           <i class="material-icons msgI">edit</i>
                           編輯
                        </a>
